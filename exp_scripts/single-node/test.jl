...
function benchmark_julia_performance(f, throwout,iters, creations, chan_size, nprocs, size, def, newval, set, compare )
	println("#measure task throughput- function", f, "iters", iters,"throwout", throwout,"creations", creations)
